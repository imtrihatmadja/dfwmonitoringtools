...
-- Policy: akses terbuka (untuk pengembangan; batasi per role saat produksi)
DO $$ DECLARE tbl text;
BEGIN
  FOREACH tbl IN ARRAY ARRAY['projects','project_indicators','indicator_updates','indicator_evidence','project_activities','activity_notes','activity_files'] LOOP
...
-- ===================== REALTIME =====================
-- ALTER PUBLICATION supabase_realtime ADD TABLE projects;  ← skip jika sudah terdaftar
-- ALTER PUBLICATION supabase_realtime ADD TABLE project_activities;  ← skip jika sudah terdaftar

-- ===================== STORAGE =====================
-- Jalankan di Dashboard Supabase → Storage → New Bucket:
-- Nama bucket: activity-files | Public: ON
