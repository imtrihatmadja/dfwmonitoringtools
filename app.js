...
// Menghitung progress proyek dari indikator yang diinput di form (Step 2)
...
document.getElementById("submitAllBtn").addEventListener("click", async () => {
  ...
  try {
    ...
    const p = {
      ...
      progress    : calcProgressFromIndicatorsForm(), // dihitung otomatis dari indikator
...
function resetForm() {
  ...
  // progress tidak lagi diisi manual — dihitung otomatis
  indicators = [];
}
...
window.fillFormEdit = function (idx) {
  ...
  // progress tidak diisi manual — dihitung otomatis dari aktivitas/indikator
