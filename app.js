      ...
      <div class="proj-card ${cls}" onclick="openProjectDetail(window.allProjects[${i}])">
        ...
        <div class="proj-card-budget">
          ...
          <div style="border-top:1px solid #f1f5f9;margin:8px 0 6px;padding-top:8px">
            ...
            ${item.project_outcomes && item.project_outcomes.length ? `<div style="font-size:11px;color:#475569"><span style="font-weight:700;color:#7c3aed">🏆 Outcomes (${item.project_outcomes.length}):</span><ul style="margin:3px 0 0 14px;padding:0;line-height:1.6">${item.project_outcomes.map(o => `<li>${o.outcome_text}</li>`).join("")}</ul></div>` : ""}
          </div>
        ` : ""}
